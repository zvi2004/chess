...
Bishop::Bishop(const bool isWhite, const int x, const int y, const char type) : Piece(isWhite, x, y, type)
{}
/*
...
*/
int Bishop::isLegal(int destX, int destY, bool isWhite, bool color)
{
	...
	if (abs(this->x - destX) == abs(this->y - destY)) {}//legal move
	else
	{
		return 6;
	}
...
output: num of error or 0 if legal
*/
int Bishop::nextMoveIndex(Piece* board[][8], int destX, int destY)
{
	...
	if (this->x < destX && this->y < destY)//check if going up right is clear
	{
