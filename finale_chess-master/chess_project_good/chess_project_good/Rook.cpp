...
Rook::Rook(const bool isWhite, const int x, const int y, const char type) : Piece(isWhite, x, y, type)
{}
/*
...
*/
int Rook::isLegal(int destX, int destY, bool isWhite, bool color)
{
	...
	if ((this->x != destX && this->y == destY) || (this->y != destY && this->x == destX)) {}//legal move
	else
	{
		return 6;
	}
...
output: num of error or 0 if legal
*/
int Rook::nextMoveIndex(Piece* board[][8], int destX, int destY)
{
